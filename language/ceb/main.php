<?php
    ...
    "ConsentPublicationText2" => ", etc. Kung muoyon ka niining mga paggamit sa mga datos, i-tick ang box sa ubos. Kung dili ka muoyon niining mga paggamit sa imomg datos, palihog ayaw i-tick ang box.",
